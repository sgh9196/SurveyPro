...
public class ServerAlertCTL {
	
	/* COMMIT Dialog (YES, NO) */
	protected boolean commitDialog(String _msg) {
	...
	/* WARNING Dialog (Yes) */
	protected void warningDialog(String _msg) {
	...
	protected void informationDialog(String _msg) {
	...
	protected String textinputDialog() {
